...
wd <- "~/PhD/SCP.replication/inst/renvs/liang2020/"
setwd(wd)
...
renv::install(c("tidyverse", "patchwork", "benchmarkme", 
                "clusterProfiler", "org.Hs.eg.db", "UpSetR"))
...
## `inst/renvs/liang2020` directory to the desired system and run:
## `renv::activate("inst/renvs/liang2020/")`
## `renv::restore()`
