...
wd <- "~/PhD/SCP.replication/inst/renvs/zhu2019EL/"
setwd(wd)
...
renv::install(c("tidyverse", "patchwork", "benchmarkme", "biomaRt",
                "CellTrails", "scater", "splines"))
...
## `inst/renvs/zhu2019EL` directory to the desired system and run:
